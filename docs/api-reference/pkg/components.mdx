...
NewBaseMessagePayload creates a new instance of BaseMessagePayload from the send configs, choosing phone \(\`to\`\) vs BSUID \(\`recipient\`\) serialization. SendToRecipient \(BSUID\) takes precedence when both are set — callers should set exactly one; setting both is only meaningful for Meta precedence tests.
...
<a name="CallToAction.SetDisplayText"></a>
### func \(\*CallToAction\) SetDisplayText
...
<a name="CallToAction.SetUrl"></a>
### func \(\*CallToAction\) SetUrl
...
<a name="ContactRequestMessage"></a>
## type ContactRequestMessage
...
<a name="NewContactRequestMessage"></a>
### func NewContactRequestMessage
...
<a name="ContactRequestMessage.SetBodyText"></a>
### func \(\*ContactRequestMessage\) SetBodyText
...
<a name="ContactRequestMessage.ToJson"></a>
### func \(\*ContactRequestMessage\) ToJson
...
<a name="ContactRequestMessageApiPayload"></a>
## type ContactRequestMessageApiPayload
...
<a name="ContactRequestMessageBody"></a>
## type ContactRequestMessageBody
...
<a name="ContactRequestMessageParams"></a>
## type ContactRequestMessageParams
...
<a name="CtaMessage.SetAction"></a>
### func \(\*CtaMessage\) SetAction
...
<a name="CtaMessage.SetBody"></a>
### func \(\*CtaMessage\) SetBody
...
<a name="CtaMessage.SetFooter"></a>
### func \(\*CtaMessage\) SetFooter
...
<a name="CtaMessage.SetHeader"></a>
### func \(\*CtaMessage\) SetHeader
...
<a name="CtaMessage.ToJson"></a>
### func \(\*CtaMessage\) ToJson
...
<a name="CtaMessageAction"></a>
## type CtaMessageAction
...
<a name="CtaMessageActionParams"></a>
## type CtaMessageActionParams
...
<a name="CtaMessageApiPayload"></a>
## type CtaMessageApiPayload
...
<a name="CtaMessageFooter"></a>
## type CtaMessageFooter
...
<a name="CtaMessageHeader"></a>
## type CtaMessageHeader
...
<a name="CtaMessageHeaderType"></a>
## type CtaMessageHeaderType
...
<a name="CtaMessageHeaderTypeText"></a>
...
<a name="CtaMessageParams"></a>
## type CtaMessageParams
...
<a name="TemplateMessage.AddCarousel"></a>
### func \(\*TemplateMessage\) AddCarousel

```go
func (tm *TemplateMessage) AddCarousel(params TemplateMessageComponentCarouselType) error
```

AddCarousel adds \(or overrides\) a carousel component in the template message. Only one carousel is allowed, and a carousel can contain up to 10 cards.
...
<a name="TemplateMessageCarouselCard"></a>
## type TemplateMessageCarouselCard
...
<a name="TemplateMessageComponentCarouselType.GetComponentType"></a>
### func \(TemplateMessageComponentCarouselType\) GetComponentType
