...
TemplateMessageBodyAndHeaderParameter represents parameters for body and header components. \*\*New Change:\*\* Added the optional ParameterName field for named parameters.
...
type TemplateMessageComponentButtonType struct {
    ...
    Parameters []TemplateMessageParameter         `json:"parameters" validate:"required"` // Parameters for the button component.
}
```
...
type TemplateMessageComponentHeaderType struct {
    ...
    Parameters []TemplateMessageParameter   `json:"parameters" validate:"required"` // Parameters for the header component.
}
```
