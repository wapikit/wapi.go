...
func NewCatalogManager(businessAccountId string, requester request_client.RequestClient) *CatalogManager {
...
type ProductItem struct {
	Id                                                    string       `json:"id"`
	AdditionalImageCdnUrls                                [][]KeyValue `json:"additional_image_cdn_urls,omitempty"`
	...
	ImageCdnUrls                                          []KeyValue   `json:"image_cdn_urls,omitempty"`
	...
	ProductCatalog                                        string       `json:"product_catalog,omitempty"`
...
type CatalogProduct = ProductItem
...
func (cm *CatalogManager) GetCatalogProducts(catalogId string) ([]CatalogProduct, error) {
